...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('dannuttle.tt.omtrdc.net', 'dannuttle',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"http://admin3.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=dannuttle.tt.omtrdc.net'
    + '&clientCode=dannuttle"><' + '\/scr' + 'ipt>');
};
...
document.write('<script type="text/javascript" src="http://dannuttle.tt.omtrdc.net/m2/dannuttle/ubox/raw?mbox=redirectUbox&&mboxXDomain=disabled&mboxContentType=text%2Fjavascript&mboxURL='+escape(location.toString())+'&mboxSession='+sessionId+'&mboxPC='+PCId+'&mboxHost='+location.hostname+'&mboxDefault=http://www.teamoffermatica.com/dannuttle/training/token_replace_in_offer.html"></'+'script>');
**/
